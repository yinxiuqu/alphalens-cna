![封面：深蓝色调，一条 K 线在右侧突然断裂成空白，一把放大镜停在断裂处](placeholder)
...
![信息图：左侧「有行情的股票 5905 只」，中间「标记退市的 339 只」，右侧「分析缓存里的退市股 0 只」用红色标出](placeholder)
...
![信息图：5 个分位的腰斩率柱状图，Q1 4.4% 与 Q5 3.2% 高于中间 1.7%，呈 U 型](placeholder)
...
![信息图：RankIC 修正轨迹折线图，−0.059 → −0.0473 → −0.0400 → +0.029 共 4 个节点，最后一段跨越 0 轴](placeholder)
